...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :ansible_monitor do |monitor|
    monitor.vm.hostname = "monitor"
    monitor.vm.network :private_network, ip: "192.168.33.20", virtualbox__intnet: "intnet"
    monitor.vm.network :forwarded_port,  guest: 3000, host: 30000
    monitor.vm.network :forwarded_port,  guest: 22, host: 2204, id: "ssh"
    monitor.vm.network :forwarded_port,  guest: 9090, host: 9090
    #monitor.vm.synced_folder "./monitor", "/vagrant_data"
  end
